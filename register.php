                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
                            ...
                            <?php 
                                if(!empty($_SESSION['register']) && $_SESSION['register'] == 2)
                                {
                            ?>
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-sm-offset-3 form-box">
                            ...
                            <div class="form-bottom">
                                <form role="form" action="register_prtcl.php" method="post" class="login-form">
                                    ...
                                    <div class="form-group">
                                        <label class="sr-only" for="form-hp">Mobile phone number</label>
                                        <input type="text" name="no_hp" placeholder="Mobile phone" class="form-username form-control" id="form-username">
                                    </div>
